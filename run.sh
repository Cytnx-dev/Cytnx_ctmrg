...
python main.py --chi 16 --bondim 4 --CTMARGS_ctm_conv_tol 0 --CTMARGS_ctm_max_iter 10 --CTMARGS_projector_svd_method "GESVD" --GLOBALARGS_device 0

# python main.py --chi 32 --bondim 4 --CTMARGS_ctm_conv_tol 0 --CTMARGS_ctm_max_iter 10 --CTMARGS_projector_svd_method "GESVD" --GLOBALARGS_device 0
